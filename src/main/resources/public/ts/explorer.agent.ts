...
import { AbstractBusAgent, ACTION, CreateFolderParameters, CreateFolderResult, framework, GetContextParameters, GetContextResult, GetResourcesParameters, GetResourcesResult, IContext, ID, RESOURCE } from 'ode-ts-client';
 ...
 * => Le bundle généré sera recopié sous /explorer/explorer.agent.js (et non pas /blog...)
 */
